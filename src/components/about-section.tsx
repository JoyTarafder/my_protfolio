...
const socialLinks = [
  { icon: "lucide:github", url: "https://github.com/JoyTarafder", label: "GitHub" },
  { icon: "lucide:linkedin", url: "www.linkedin.com/in/joy-tarafder", label: "LinkedIn" },
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <Card className="flex-1 bg-background/60 backdrop-blur-sm border border-default-200">
            <CardBody className="gap-6">
              ...
              I'm a Computer Science Engineering (CSE) student (undergraduate last semester) with a proven track record of developing webbased projects using HTML, CSS, and JavaScript. Possessing one year of hands-on experience in web development, I am now seeking
              a challenging internship opportunity to enhance my skills, gain practical industry experience, and contribute effectively to innovative
              projects. I'm eager to leverage my technical expertise and passion for coding to make valuable contributions to a dynamic team while
              continuously learning and growing in web development.
              </p>
              
              <div className="flex flex-wrap gap-3">
                {["React", "JavaScript", "TailwindCSS", "Node.js"].map((tech) => (
                  <span 
                    key={tech}
