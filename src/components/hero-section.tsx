...
export function HeroSection() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary-50/50 via-background to-secondary-50/30 animate-gradient-xy" />
      <div
        className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,_var(--dots)_1px,_transparent_1px)] bg-[length:24px_24px]"
        style={{ "--dots": "rgba(0,0,0,0.4)" } as any}
      />
      <div className="absolute inset-0 bg-[url('/path/to/your/pattern.png')] opacity-20 animate-pattern-move" />
      <div className="absolute inset-0 bg-[url('/path/to/your/another-pattern.png')] opacity-10 animate-pattern-move-reverse" />
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <p className="text-xl md:text-2xl text-default-600 mb-12 leading-relaxed max-w-2xl mx-auto">
          A passionate frontend developer crafting beautiful and intuitive
          digital experiences
        </p>
